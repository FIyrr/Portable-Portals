...
execute if score @s portport.animation matches 15 run data merge entity @s {brightness:{sky:0,block:0},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-0.25f,-0.25f,-2.25f],scale:[1f,0.8125f,1f]},start_interpolation:-1}

execute if score @s portport.animation matches 30 run data merge entity @s {transformation:{scale:[1f,1f,1f]}, block_state:{Name:"minecraft:end_portal_frame",Properties:{facing:"south"}}}
...
execute if score @s portport.animation matches 25 align xyz run summon block_display ~ ~-0.5 ~-2 {interpolation_duration:10, brightness:{sky:0,block:0},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0.5f,0f],scale:[1f,1f,1f]},start_interpolation:-1, block_state:{Name:"minecraft:end_portal_frame"},Glowing:True,glow_color_override:9175295,Tags:["portport.block_display","portport.end_frame","portport.6"]}

execute if score @s portport.animation matches 25 align xyz run summon block_display ~ ~-0.5 ~-2 {interpolation_duration:10, brightness:{sky:0,block:0},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0.5f,0f],scale:[1f,1f,1f]},start_interpolation:-1, block_state:{Name:"minecraft:end_portal_frame"},Glowing:True,glow_color_override:9175295,Tags:["portport.block_display","portport.end_frame","portport.8"]}
...
execute if score @s portport.animation matches 46 run setblock ~ ~ ~-2 end_portal_frame[facing=south]
