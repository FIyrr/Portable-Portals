...
execute if score @s portport.animation matches 1 run data merge entity @s {transformation:{scale:[1f,1f,1f],translation:[1f,0.5f,0f]},start_interpolation:-1}
...
execute if score @s portport.animation matches 21 run setblock ~1 ~1 ~ end_portal_frame[facing=south]
